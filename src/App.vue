...
const visage = ref(stored('visage', DEFAULT_VISAGE, (v) => VISAGE_BY_ID.has(v)))
 ...
 * prose le nom s'ecrit « Cliplab », et c'est cette forme que portent
 ...
 * sa largeur mesuree en cadratins (3,853). Changer ce nom impose de la remesurer.
 */
const NOM = 'CLIPLAB'
