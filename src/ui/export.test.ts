...
describe('nom de fichier', () => {
  ...
  it('translittere les accents et separe les mots', () => {
    expect(nomFichier('Cycle par défaut', '', '', 'mp4')).toBe('cliplab-cycle-par-defaut.mp4')
    expect(nomFichier('Été 2026', '', '', 'gif')).toBe('cliplab-ete-2026.gif')
  })

  it('survit a des ids vides', () => {
    expect(nomFichier('', '', '', 'png')).toBe('cliplab.png')
  })
})
